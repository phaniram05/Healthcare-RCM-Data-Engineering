...
df_hosa=spark.read.parquet("/mnt/bronze/hos-a/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("/mnt/bronze/hos-b/patients")
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS audit.patients (
...
# MAGIC MERGE INTO audit.patients AS target
...
# MAGIC %sql
# MAGIC select Patient_Key, count(*) as visits from audit.patients
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT Patient_Key, COUNT(*) as visits
# MAGIC FROM audit.patients
# MAGIC GROUP BY Patient_Key
# MAGIC ORDER BY visits;
