...
df_hosa=spark.read.parquet("/mnt/bronze/hos-a/transactions")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/mnt/bronze/hos-b/transactions")
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS audit.transactions (
...
# MAGIC MERGE INTO audit.transactions AS target USING quality_checks AS source ON target.TransactionID = source.TransactionID
