...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "dbfs:/mnt/bronze/hos-a/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "dbfs:/mnt/bronze/hos-b/encounters"
# MAGIC );
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS audit.encounters (
...
# MAGIC MERGE INTO audit.encounters AS target
...
# MAGIC MERGE INTO audit.encounters AS target USING quality_checks AS source ON target.EncounterID = source.EncounterID
...
# MAGIC %sql
# MAGIC select SRC_EncounterID,datasource,count(patientid) from audit.encounters
# MAGIC group by all
